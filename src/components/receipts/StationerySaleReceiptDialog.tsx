...
import { StationerySaleReceipt } from "@/components/receipts/StationerySaleReceipt";
import {
  printThermalElement,
...
import type {
  StationerySaleLineReceipt,
  StationerySaleReceiptData,
  ThermalPaperWidth,
} from "@/lib/receipts/types";

export type StationerySaleForDialog = {
...
export function StationerySaleReceiptDialog({
  open,
  onClose,
  school,
  sale,
  ...
  const receiptData: StationerySaleReceiptData = useMemo(
    () => ({
      school,
      receiptNumber: sale.receiptNumber,
      soldAt: sale.createdAt,
      payerName: sale.payerName,
      method: sale.method,
      lines: sale.lines,
      ...
      <div className="flex max-h-[min(90vh,40rem)] flex-col">
        <div className="border-b border-[var(--gray-100)] px-6 py-4">
          ...
          <p className="mt-1 text-[15px] text-[var(--gray-600)]">
            Choose paper width, then print to your thermal or POS printer.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-6 py-4">
          ...
          <div className="rounded-[var(--radius-sm)] border border-[var(--gray-200)] bg-[var(--gray-50)] py-4">
            ...
            <StationerySaleReceipt id={receiptDomId} data={receiptData} paperWidth={paperWidth} />
          </div>
